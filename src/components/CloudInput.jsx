...
function CloudInput({ onSubmit, advice, isSubmitted, mood, onReset }) {
  ...
  return (
    <form
      ...
      className="flex flex-col mt-8 max-w-2xl w-full px-4 mx-auto transition-all duration-300"
    >
      <textarea
        ...
        rows={6}
        className="w-full h-36 text-sm leading-relaxed border-2 border-[#a3c8f4] rounded-xl bg-[#f0f5ff] text-[#3e4a66] font-mono shadow-md hover:shadow-lg focus:outline-none focus:ring-3 focus:ring-[#cddafd] p-4 resize-none transition-all duration-300 placeholder-[#9aa6c7] mb-3"
      />
